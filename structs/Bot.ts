...
export class Bot {
  ...
  public constructor(public readonly client: Client) {
    ...
    this.client.on("ready", () => {
      ...
      this.setBotStatus("online"); // Change status to "online"
    });
  ...
  this.client.on(Events.InteractionCreate, async (interaction: Interaction): Promise<any> => {
    ...
    try {
      const permissionsCheck: PermissionResult = await checkPermissions(command, interaction as ChatInputCommandInteraction);
...
public setBotStatus(status: PresenceStatusData) {
